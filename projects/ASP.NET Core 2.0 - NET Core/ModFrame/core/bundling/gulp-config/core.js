...
gulp.task("2-MF-start-watchers", ["0-MF-run-and-clean", "MF-files-watch", "MF-globals-watch", "MF-layouts-watch", "MF-modules-watch", "MF-personal-plugins-watch", "MF-packages-watch"]);
...
gulp.task("4-MF-packages", ["MF-packages"]);

//Main task which gets called to load fire of the file sync for visual studio
gulp.task("5-MF-files", ["MF-files", "MF-files-clean"]);

//Main task that builds the minifcation and compilation of all the different types
gulp.task("MF-release-build", ["MF-files", "MF-packages", "MF-globals", "MF-layouts", "MF-modules", "MF-personal-plugins", "MF-external-plugins-sync"]);

//Main task that builds only the compilation of all the different types *no minification*
gulp.task("MF-debug-build", ["MF-files", "MF-packages", "MF-debug-globals", "MF-debug-layouts", "MF-debug-modules", "MF-debug-personal-plugins", "MF-external-plugins-sync"]);